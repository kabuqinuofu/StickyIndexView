...
import com.yc.stickyindexview.widget.SideBar;
 ...
 */
public class StickyIndexView extends RelativeLayout implements SideBar.OnSideBarTouchListener, Observer {
    ...
    /**
     * 当前视图{@link StickyIndexView} 的数据适配器
     */
    private StickyIndexViewAdapter mAdapter;

    public StickyIndexView(Context context) {

        this(context, null);
    }

    public StickyIndexView(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }

    public StickyIndexView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initSideBar(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.StickyIndexView);
            mSideBar.initAttrs(typedArray);
            mSideBarWidth = typedArray.getDimensionPixelSize(R.styleable.StickyIndexView_sideBarWidth, defaultSideBarWidth);
            typedArray.recycle();
        }
    ...
    private void initCenterOverlayView(Context context) {
        ...
        mCenterOverlayView.setBackgroundResource(R.drawable.stickyindexview_center_overlay_bg);
    ...
    class RecyclerViewScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            StickyIndexEntity entity = mAdapter.getItem(firstVisiblePosition);
            ...
            //获取第二个可见项实体对象
            StickyIndexEntity secondVisibleEntity = mAdapter.getItem(firstVisiblePosition + 1);
    ...
    public void setAdapter(StickyIndexViewAdapter adapter) {
     ...
     * @param adapter
     */
    public void addIndexHeaderAdapter(IndexHeaderOrFooterAdapter adapter) {
     ...
     * @param adapter
     */
    public void addIndexFooterAdapter(IndexHeaderOrFooterAdapter adapter) {
